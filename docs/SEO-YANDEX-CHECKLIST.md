...
>
> **Что уже сделано на сайте (циклы c99/c100, руками владельца не нужно):**
...
> админки. Пункты 4–6, 13–16, 18, 26 ниже уже закрыты кодом сайта —
> отмечены «✅ (сделано кодом)».
...
27. ☐ Страница **«О компании»** с машины-читаемыми фактами: год основания, количество событий, ИП, география, форматы — лучший источник для цитирования ИИ.
28. ☐ **IndexNow** (Яндекс + Bing одним ключом): отправлять URL при обновлениях → https://yandex.ru/support/webmaster/ru/indexnow/reference
29. ☐ Раз в месяц — «аудит ассистентов»: спросить у ChatGPT (с поиском), Perplexity, Алисы/Нейро, Gemini: «Нилов Кейтеринг СПб», «nilov catering», «кейтеринг спб» — фиксировать, кто цитирует и откуда; закрывать пробелы (нет в Bing → IndexNow; нет карточки → Бизнес).
