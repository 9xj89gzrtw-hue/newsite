...
const SERVICES: HaccService[] = [
  ...
  },
  {
    ...
    tag: "Миксология",
    tint: "#F5EEE2",
    media: "/media/c56/c56-bar.webp",
    mediaAlt: "Винтажный фургон с выездной бар-стойкой, бармен и гости у стойки на мероприятии",
  ...
  },
  {
    ...
    tag: "Живая кухня",
    tint: "#F6E0DB",
    media: "/media/c56/c56-shou.webp",
    mediaAlt: "Рука шеф-повара кладёт булочку на бургер на гриль-станции с живым огнём",
  ...
  },
  {
    ...
    tag: "Доставка",
    tint: "#E6EBDF",
    media: "/media/c56/c56-boksy.webp",
    mediaAlt: "Картонный кейтеринг-бокс с салатом, половинкой яйца и сухариками среди других боксов",
  ...
  },
  {
    ...
    tag: "Всё, кроме еды",
    tint: "#F3E3E8",
    media: "/media/c56/c56-logistika.webp",
    mediaAlt: "Рука стаффа расставляет бокалы с напитками на событии, на фоне размытых гостей",
