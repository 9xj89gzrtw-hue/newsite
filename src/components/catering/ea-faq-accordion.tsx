  ...
  return (
    ...
    >
      <div className="ea-container ea-container--narrow">
        ...
        >
          <span>
            Не нашли свой вопрос? Напишите нам — отвечаем в любое время, обычно в течение 15 минут.
          </span>
