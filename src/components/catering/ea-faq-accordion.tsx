...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Еда, доставка, сервировка, посуда, текстиль, повар и официанты на месте, а также лёгкое цветочное сопровождение на столах (как во всех пакетах меню). Не входит: аренда площадки, алкоголь, музыка и расширенное флористическое оформление — поможем организовать по запросу.",
  },
  {
  ...
  return (
    ...
    >
      <div className="ea-container ea-container--narrow">
        ...
        >
          <span>
            Не нашли свой вопрос? Напишите нам — ответим в течение 15 минут в рабочее время.
          </span>
