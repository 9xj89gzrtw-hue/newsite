...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    a: "От 30 гостей для банкетов и 50 для фуршетов. Для корпоративных обедов — от 15 порций. Если меньше — рассмотрите наши коробочные сеты.",
  },
  {
  ...
  },
  {
    ...
    a: "Предоплата 50% при подписании договора, остаток — в течение 3 рабочих дней после события. Работаем с юр. лицами по безналичному расчёту с НДС.",
  },
  {
