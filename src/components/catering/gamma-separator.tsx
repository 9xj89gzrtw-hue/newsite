 ...
 *  - Centered handwritten watermark "nilov catering" in Marck Script
 ...
 *    (espresso) for the duration of this band — the "nilov catering" handwritten
 ...
 *  - The "nilov catering" watermark text now drops in per-char via SplitTextReveal
 *    mode="chars" stagger={0.04} — each letter lifts in from below with a
 *    40ms stagger (split-type сохраняет пробел между словами как обычный
 *    текст-узел, поэтому двухсловный вордмарк рендерится с нормальным
 *    интервалом). The -6° tilt, Marck Script face, and 70% opacity white
      ...
      <ClipPathReveal direction="left" duration={1.0} className="absolute inset-0">
        ...
        >
          ...
          {/* Gamma-style -6° handwritten watermark — centered, rotated,
              ...
              the inner SplitTextReveal splits "nilov catering" into chars
              (пробел между словами остаётся обычным текст-узлом) and
