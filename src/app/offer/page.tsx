        ...
        <div className="prose-legal space-y-8 text-ink-soft">
          ...
          <Section title="2. Перечень услуг">
            ...
            <ul>
              ...
              <li>Доставка закусок (гастро-боксы) по городу;</li>
          ...
          <Section title="6. Расторжение договора">
            ...
            <p>
              ...
              14 дней до мероприятия удерживаются документально подтверждённые фактически понесённые расходы (возмещается
