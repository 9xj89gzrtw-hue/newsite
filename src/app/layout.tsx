...
const jsonLd = {
  ...
  sameAs: [
    ...
    SOCIALS.youtube,
    /* c89: sameAs — публичные профили (телеграм-канал @nilov_official,
     * YouTube @nilovcatering — от владельца). Личные чаты t.me/+7911… и
     * wa.me — контактные каналы, не профили. Rutube НЕ в sameAs: канала
     * не найдено, поиск-ссылка = анти-сигнал валидаторам (F2/K3-прецедент
     * max.ru) — ждём настоящий URL от владельца. MAX-профиля нет (404). */
  ],
