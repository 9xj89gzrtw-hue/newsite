...
export const metadata: Metadata = {
  ...
  title: {
    default: "nilov catering — Кейтеринг в Санкт-Петербурге от 660 ₽/чел",
    template: "%s | nilov catering",
  },
  /* F2 (K3-MINOR): 192 → 152 симв. — ключи сохранены: «кейтеринг Санкт-Петербург",
   * цены-ЦИ (660/900/2450/4470), телефон. Усечение хвоста «Рассчитайте стоимость
   * онлайн за 30 секунд» — CTA-фраза дублирована в title. */
  description:
    "Кейтеринг в Санкт-Петербурге: доставка закусок от 660 ₽, кофе-брейк от 900 ₽, фуршет от 2450 ₽, банкет от 4470 ₽/чел. Смета за 30 секунд: +7 (911) 941-72-05.",
  keywords: [
    "кейтеринг",
    "кейтеринг СПб",
...
const jsonLd = {
  ...
  description: "«Еда как искусство» — выездной кейтеринг полного цикла в Санкт-Петербурге. Доставка закусок от 660 ₽, кофе-брейк от 900 ₽, фуршет от 2450 ₽, банкет от 4470 ₽ за человека; заказы — от одного гостя.",
  url: siteUrl,
   ...
   * доставка закусок). Ничего не выдумано (c86: офисные обеды сняты). */
  knowsAbout: [
    "Фуршеты",
    "Банкеты",
    "Свадебный кейтеринг",
